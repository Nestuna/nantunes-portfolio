...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Design et developpement de la refonte UI / UX  intégrale de la navigation de Nudgis. \
       ...
       \n \nCela a été l\'occasion de m\'initier á Angular, mais aussi la construction d\'un projet de A á Z. J\'ai du parfois modifier l\'API, et apprendre sa logique. \
       Egalement j\'ai pu monter en competence en TDD, en construisant des tests unitaires et end-to-end.",

    stack: ['Angular', 'Material', 'Jest', 'Webdriver I/O', 'Django', 'Docker', 'TDD'],
    repositories: [],
    projectLink: '',
  },
  {
  ...
  },
  {
    ...
    description:
      "Messagerie éphémère et privée. Le but est pouvoir créer des conversations privée joignable seulement via un ID unique, et qui soit supprimée au bout d'un temps donnée. Le temps peut etre configurée",
...
export const experiences: Record<'pro' | 'training', Experience[]> = {
  pro: [
    ...
    },
    {
      ...
      description:'Prise d’appels et régulation médicale pour l\'envoi d\'un médecin a domicile ou redirection vers les services d\'urgence.',
      skills: [
        "Communication d'equipe rigoureuse",
